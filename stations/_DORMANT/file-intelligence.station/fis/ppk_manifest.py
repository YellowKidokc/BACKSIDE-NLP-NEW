...
DEFAULT_PPK_PACKAGE = Path(
    r"\\dlowenas\brain\Backside\_models\_Models\preference-engine-ppk"
)
...
class PPKManifestBridge:
    ...
    def build_for_file(
        ...
        manifest["fis_ppk_bridge"] = {
            ...
            "selected_preference_spine": "preference-engine-ppk",
            "support_engines": [
                "preference-engine-implicit",
                "preference-engine-river",
                "preference-engine-markovify",
            ],
        }
