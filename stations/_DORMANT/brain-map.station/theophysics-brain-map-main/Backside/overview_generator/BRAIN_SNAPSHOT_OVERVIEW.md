...
- `X:\EXPORTS\brain-overview\brain-overview.json`
- `X:\EXPORTS\brain-overview\index.html`
- `X:\EXPORTS\brain-overview\README.md`
...
For isolated smoke tests, override the destination with `BRAIN_OVERVIEW_OUTPUT_DIR`.
