...
```text
X:\Backside\stations\paper-grader-nlp.station\INPUT
```
...
```text
X:\Backside\stations\paper-grader-nlp.station\EXPORTS\paper_proof_grader
```

Archived originals:

```text
X:\Backside\stations\paper-grader-nlp.station\ARCHIVE
```

Readable report copies:

```text
X:\Backside\stations\paper-grader-nlp.station\EXPORTS\reports
```
