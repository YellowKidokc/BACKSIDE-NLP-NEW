...
- Chain-node / concept hits: {'primitive_distinction': 2, 'primitive_information': 2, 'p0_distinguishable_states': 2, 'iron_existence': 2, 'iron_grounding': 5, 'definition_information': 3, 'claim_logos_substrate': 4, 'claim_soul_persistence': 1, 'prediction_law9_displacement': 1, 'substrate_convergence_atheist_decalogue': 3, 't_info': 2, 'a1_3': 4, 'a2_1': 3, 'bc2': 3, 'bc4': 1, 'bc7': 2, 'bc8': 10, 'information_substrate': 2, 'experiment_protocol': 5, 'model_coupling': 10, 'soteriological_limit': 5, 't3_1': 5, 'entropy_thermo': 5, 'meta_1': 5, 'meta_3': 6, 'falsifiability': 5, 'master_equation_generator': 5, 'feb14_boundary': 3, 't16_1': 3, 'e19_1': 5, 'justice_mercy_operator_identity': 1, 'axioms_110_114_evidence': 2, 'a5_1': 8, 'bc1': 4, 'observer_actualization': 4, 'master_equation': 2, 'truth_ground_presystem': 3, 'final_1': 4, 'a1_1': 2, 'meta_2': 4, 'closure': 2, 'omega': 2, 'truth_ground': 2, 'd9_1': 1, 'nt_ceiling_non_derivability': 2, 'axiom_81_grace_function': 1, 'grace_phase_transition': 2, 'prediction_gcp': 2, 'axioms_82_99_soul_moral_realism': 1, 'iron_observation': 1, 'iron_moral_physics': 1, 'iron_spiritual_reality': 1, 'theorem_observer': 1, 'theorem_consciousness': 1, 'claim_terminal_observer': 1, 'claim_spiritual_warfare': 1, 'prediction_pear': 1, 'tp_terminal_observer': 1, 'tp_grace_operator': 1, 'tp_trinity_closure': 1, 'iron_conclusion': 1}
...
- Chain-node hits: Distinction, Information, Distinguishable States Are Real, Existence Block, Grounding Block, Information Definition, Self-Grounding Information Substrate, Soul Persistence, Conserved Displacement Prediction, Substrate Convergence (Atheist Decalogue), Information Primacy, Information Primacy, Substrate Requirement, Grace External to System, Three Observers Required, Information Conservation, Voluntary Coupling, Information substrate, Experimental protocol, Model coupling / susceptibility
...
- Chain-node hits: Soteriological Limit, Other Exists (Relation), Coherence Cannot Self-Increase, Entropy / thermodynamic constraint
- OpenAI verifier: not run
...
- Chain-node hits: Voluntary Coupling, System Consistency, Axiom Independence, Falsification / kill condition, Experimental protocol, Model coupling / susceptibility
- OpenAI verifier: not run
...
- Chain-node hits: Distinction, Information, Distinguishable States Are Real, Existence Block, Grounding Block, Information Definition, Self-Grounding Information Substrate, Justice-Mercy Operator Identity, Information Primacy, Information Primacy, Substrate Requirement, Coherence Cannot Self-Increase, Grace External to System, Information Conservation, Voluntary Coupling, Information substrate, Entropy / thermodynamic constraint, Model coupling / susceptibility
- OpenAI verifier: not run
...
- Chain-node hits: Grounding Block, Information Definition, Evidence Cluster, Observation Requirement, Terminal Observer Exists, Grace External to System, Voluntary Coupling, Full Master Equation, Observer / measurement, Master Equation / chi field, Experimental protocol, Model coupling / susceptibility, Truth Ground
- OpenAI verifier: not run
...
- Forward: 2/7
- Reverse: WEAKENED (missing_kill_condition, missing_mechanism, overbroad_scope, missing_boundary)
- Chain-node hits: Substrate Convergence (Atheist Decalogue), Soteriological Limit, Coherence Cannot Self-Increase, Observation Requirement, Terminal Observer Exists, Observer / measurement, Entropy / thermodynamic constraint, Experimental protocol
- OpenAI verifier: not run
...
- Chain-node hits: Observation Requirement, Terminal Observer Exists, Observer / measurement
- OpenAI verifier: not run
...
- Forward: 3/7
- Reverse: FAIL_REVIEW (missing_evidence, missing_kill_condition, missing_mechanism, overbroad_scope)
- Chain-node hits: Voluntary Coupling, The Logos Theorem, Model coupling / susceptibility
- OpenAI verifier: not run
...
- Chain-node hits: Grounding Block, Self-Grounding Information Substrate, Master Equation Generates Chain, Existence, Observation Requirement, System Consistency, System Completeness, Axiom Independence, The Logos Theorem, The Chain Is Complete, The Omega Point, Truth / Logos ground, Falsification / kill condition, Truth Ground
- OpenAI verifier: not run
...
- Forward: 3/7
- Reverse: FAIL_REVIEW (missing_evidence, missing_kill_condition, missing_mechanism, missing_boundary)
- Chain-node hits: Soteriological Limit, Master Equation Generates Chain, February 14 Boundary, Coherence Cannot Self-Increase, Observation Requirement, Grace Operator Definition, Christianity 8 of 8 BCs, Full Master Equation, Entropy / thermodynamic constraint
- OpenAI verifier: not run
...
- Chain-node hits: Voluntary Coupling, Full Master Equation, Master Equation / chi field, Model coupling / susceptibility
- OpenAI verifier: not run
...
- Forward: 3/7
- Reverse: FAIL_REVIEW (missing_evidence, missing_kill_condition, missing_mechanism, missing_boundary)
- Chain-node hits: NT Ceiling Non-Derivability, Soteriological Limit, Master Equation Generates Chain, February 14 Boundary, Coherence Cannot Self-Increase, Christianity 8 of 8 BCs, Full Master Equation, Entropy / thermodynamic constraint
- OpenAI verifier: not run
...
- Chain-node hits: Grace Function G(t), Soteriological Limit, System Completeness, Axiom Independence, The Logos Theorem, The Chain Is Complete, The Omega Point
- OpenAI verifier: not run
...
- Forward: 2/7
- Reverse: FAIL_REVIEW (missing_evidence, missing_kill_condition, missing_mechanism, missing_boundary)
- Chain-node hits: Evidence Cluster, Substrate Convergence (Atheist Decalogue), NT Ceiling Non-Derivability, Grace Phase Transition, Substrate Requirement, Observation Requirement
- OpenAI verifier: not run
...
- Forward: 2/7
- Reverse: FAIL_REVIEW (missing_evidence, missing_kill_condition, missing_mechanism, overbroad_scope)
- Chain-node hits: Global Consciousness Project, Soul and Moral Realism Cluster, Other Exists (Relation), Observation Requirement, Terminal Observer Exists, Voluntary Coupling, System Consistency, Axiom Independence, Observer / measurement, Falsification / kill condition, Model coupling / susceptibility
- OpenAI verifier: not run
...
- Forward: 6/7
- Reverse: SURVIVES_WITH_REPAIRS (missing_evidence)
- Chain-node hits: Grounding Block, Observation Block, Moral Physics Block, Spiritual Reality Block, Observer Theorem, Consciousness Theorem, Self-Grounding Information Substrate, Terminal Infinite Observer, Spiritual Warfare Real, PEAR Correlations, Global Consciousness Project, Terminal Observer at Phi Infinity, Grace as Non-Unitary External Operator, Trinity Closure at N=3, Master Equation Generates Chain, Existence, Observation Requirement, System Consistency, System Completeness, Axiom Independence, The Logos Theorem, Truth / Logos ground, Falsification / kill condition, Truth Ground
- OpenAI verifier: not run
...
- Forward: 4/7
- Reverse: WEAKENED (missing_kill_condition, missing_mechanism, overbroad_scope)
- Chain-node hits: Grace Conclusion, Grace Phase Transition, Voluntary Coupling, System Completeness, Experimental protocol, Model coupling / susceptibility
- OpenAI verifier: not run
