...
DEFAULT_REPORT_DIR = DEFAULT_ROOT / "EXPORTS" / "03_TWO_LANE_REPORTS"
DEFAULT_PIPELINE_ROWS = DEFAULT_ROOT / "EXPORTS" / "06_ANALYTICS" / "paper_rows.json"
...
def main() -> None:
    ...
    index_outputs = [p for p in sorted(outdir.glob("*.html")) if p.name != "index.html"]
    build_index(index_outputs, outdir)
    print(json.dumps({
