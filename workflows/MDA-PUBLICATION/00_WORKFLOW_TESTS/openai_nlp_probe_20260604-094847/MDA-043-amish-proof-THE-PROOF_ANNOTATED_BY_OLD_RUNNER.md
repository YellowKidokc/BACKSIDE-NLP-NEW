...
source_path: "\\dlowenas\HPWorkstation\Desktop\Master HTMl\K-Production-Ready\03-moral-decline\MDA-043-amish-proof-THE-PROOF.html"
source_sha256: c498042e986cc7bb6e3189161fb58a06610f1a9c6042edbaba9927ea51e21150
title: "The Amish Proof — A Control Group for Coherence | Moral Decline of America"
...
[← Prev](MDA-029-observer-collapsed.html)
|
...
%%{"note": "Sub-claim: sub_1 — Kill: If data shows Amish do not outperform on coherence metrics despite constraints."}%%
...
%%{"note": "WEAKEST: The paragraph is overly simplistic and lacks depth in explaining the strategic n"}%%
...
%%{"note": "Sub-claim: sub_3 — Kill: If evidence shows decline was inevitable due to external factors."}%%
...
%%{"note": "Sub-claim: sub_2 — Kill: If constraints are shown to not contribute to Amish success."}%%
...
Part 10: The Way Back](MDA-056-way-back.html)
...
%%{"ref": "theory-network-theory", "label": "Network Theory", "type": "structural"}%%

%%{"ref": "theory-entropy-and-information-theory", "label": "Entropy and Information Theory", "type": "analogical"}%%

%%{"ref": "theory-game-theory", "label": "Game Theory", "type": "analogical"}%%

%%{"ref": "theory-cultural-evolution", "label": "Cultural Evolution", "type": "structural"}%%

%%{"ref": "theory-systems-theory", "label": "Systems Theory", "type": "structural"}%%

%%[theory-network-theory]
**Network Theory** (Social Cohesion)
- Maps to: Community interdependence and small-scale networks
- Mapping: STRUCTURAL
- Free predictions: Small, tightly-knit communities will exhibit higher resilience and coherence.
- Independent arrival: Yes
%%]

%%[theory-entropy-and-information-theory]
**Entropy and Information Theory** (Social Systems)
- Maps to: Constraints reduce social entropy
- Mapping: ANALOGICAL
- Upgrade path: Demonstrate mathematical equivalence in social systems.
%%]

%%[theory-game-theory]
**Game Theory** (Collective Decision-Making)
- Maps to: Deliberate adoption of technology
- Mapping: ANALOGICAL
- Upgrade path: Formalize decision-making processes as game-theoretic models.
%%]

%%[theory-cultural-evolution]
**Cultural Evolution** (Sociology)
- Maps to: Cultural practices as adaptive strategies
- Mapping: STRUCTURAL
- Free predictions: Cultural practices that enhance group coherence will be more likely to persist.
- Independent arrival: Yes
%%]

%%[theory-systems-theory]
**Systems Theory** (Complex Systems)
- Maps to: Amish as a coherent system
- Mapping: STRUCTURAL
- Free predictions: Systems with strong internal coherence will be more resilient to external shocks.
- Independent arrival: Yes
%%]

%%semantic
{
  "paper": "MDA-043-amish-proof-THE-PROOF",
  "title": "MDA-043-amish-proof-THE-PROOF",
  "version": "2026-06-04",
  "analyzer": "annotation-injector-v1",
  "laws_coverage": {
    "L01": {
      "active": false,
      "physical": false,
  ...
  "predictions_generated": [
    "Longitudinal study comparing Amish and non-Amish communities over time with controlled variables."
  ]
}
%%
