# ST-PUB-017 — Publication Gate

**Lane:** pub
**Status:** draft
**Folder:** `stations/17_publication_gate`
**Wraps model:** `none`

## Purpose

Read all artifacts, check readiness (claims extracted, summary exists, reverse pass survived, evidence gaps acceptable, graph built, contradictions resolved). Recommend: website / Substack / Zenodo / Proof Explorer / Obsidian Canon / Review / Archive.
