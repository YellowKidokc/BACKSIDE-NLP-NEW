# ST-SUM-015 — Lossless Summary

**Lane:** sum
**Status:** draft
**Folder:** `stations/15_lossless_summary`
**Wraps model:** `gpt-4o-mini`

## Purpose

Preserve the argument without flattening: keeps claims, evidence, equations, assumptions, argument order, unresolved gaps. NOT a normal summary.
