# ST-EMBED-006 — Embed General

**Lane:** embed
**Status:** draft
**Folder:** `stations/06_embed_general`
**Wraps model:** `M-EMB-GEN-001`

## Purpose

General sentence embeddings (MiniLM) for dedup, routing, and quick similarity.
