# ST-NLP-015 — Rhetorical Temperature

**Lane:** nlp
**Status:** draft
**Folder:** `stations/43_rhetorical_temperature`
**Wraps model:** `M-REASON-001`

## Purpose

Measure rhetorical temperature: emotional escalation, aggressive/defensive spikes affecting credibility.
