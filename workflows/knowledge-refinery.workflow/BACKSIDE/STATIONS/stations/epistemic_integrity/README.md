# ST-NLP-004 — Epistemic Integrity

**Lane:** nlp
**Status:** draft
**Folder:** `stations/32_epistemic_integrity`
**Wraps model:** `M-REASON-001`

## Purpose

Detect overclaims, unsupported certainty, hedging appropriateness, speculative-without-flag.
