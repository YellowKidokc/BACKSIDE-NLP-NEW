# ST-NLP-005 — Compression Density

**Lane:** nlp
**Status:** draft
**Folder:** `stations/33_compression_density`
**Wraps model:** `M-REASON-001`

## Purpose

Measure conceptual compression density per sentence/paragraph (too low=fluff, too high=unreadable).
