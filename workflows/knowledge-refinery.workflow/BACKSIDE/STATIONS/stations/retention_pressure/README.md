# ST-NLP-002 — Retention Pressure

**Lane:** nlp
**Status:** draft
**Folder:** `stations/30_retention_pressure`
**Wraps model:** `M-REASON-001`

## Purpose

Measure hook strength / retention pressure: forward pull, novelty density, tension/resolution pacing.
