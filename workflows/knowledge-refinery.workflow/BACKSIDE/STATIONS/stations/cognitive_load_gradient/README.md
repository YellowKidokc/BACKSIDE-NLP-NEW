# ST-NLP-006 — Cognitive Load Gradient

**Lane:** nlp
**Status:** draft
**Folder:** `stations/34_cognitive_load_gradient`
**Wraps model:** `M-REASON-001`

## Purpose

Measure cognitive load gradient: ramp smoothness, wall paragraphs, complexity spikes.
