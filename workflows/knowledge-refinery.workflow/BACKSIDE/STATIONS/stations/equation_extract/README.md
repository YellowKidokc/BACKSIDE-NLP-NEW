# ST-CONV-021 — Equation Extract

**Lane:** conv
**Status:** draft
**Folder:** `stations/21_equation_extract`
**Wraps model:** `local:docling`

## Purpose

Extract equations from converted document into canonical LaTeX/MathML form.
