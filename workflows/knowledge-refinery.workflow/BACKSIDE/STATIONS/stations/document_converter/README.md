# ST-CONV-013 — Document Converter

**Lane:** conv
**Status:** draft
**Folder:** `stations/13_document_converter`
**Wraps model:** `none`

## Purpose

Convert source files to clean Markdown using MarkItDown / Docling / Marker. Extract text, tables, links, images. Produce source.md + conversion_report.yml.
