# ST-GRAPH-018 — Knowledge Graph Extractor

**Lane:** graph
**Status:** draft
**Folder:** `stations/18_knowledge_graph_extractor`
**Wraps model:** `M-GRAPH-001`

## Purpose

Extract nodes/edges and supports/contradicts/depends_on.
