# ST-RED-028 — Cross Output Contradiction

**Lane:** red
**Status:** draft
**Folder:** `stations/28_cross_output_contradiction`
**Wraps model:** `M-NLI-STRONG-001`

## Purpose

Cross-output contradiction scan over artifacts emitted by prior stations.
