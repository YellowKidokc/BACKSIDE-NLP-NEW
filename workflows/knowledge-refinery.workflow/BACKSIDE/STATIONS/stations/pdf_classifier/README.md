# ST-CONV-017 — Pdf Classifier

**Lane:** conv
**Status:** draft
**Folder:** `stations/pdf_classifier`
**Wraps model:** `local:pypdfium2`

## Purpose

Open a PDF and decide whether it has selectable text (route to pdf_to_md) or is image-only/scanned (route to ocr_scan). Pre-dispatcher for the dispatcher.
