...
def main() -> int:
    ...
    payload={"status":"todo","station":station_dir.name,"note":"Runner stub only (Postgres/NLI wiring pending).","input":str(inp),"generated":datetime.now().isoformat(timespec="seconds")}
