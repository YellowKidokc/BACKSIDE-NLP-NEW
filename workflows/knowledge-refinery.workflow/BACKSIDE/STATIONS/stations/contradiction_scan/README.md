# ST-NLI-005 — Contradiction Scan

**Lane:** nli
**Status:** draft
**Folder:** `stations/contradiction_scan`
**Wraps model:** `M-NLI-STRONG-001`

## Purpose

Contradiction scan: read axioms from Postgres and run NLI(claim, axiom) across corpus; emit contradiction hits over threshold.
