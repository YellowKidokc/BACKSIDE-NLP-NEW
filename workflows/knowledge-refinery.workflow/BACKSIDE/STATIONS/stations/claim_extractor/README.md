# ST-CLAIM-014 — Claim Extractor

**Lane:** claim
**Status:** draft
**Folder:** `stations/14_claim_extractor`
**Wraps model:** `gpt-4o-mini`

## Purpose

Read source.md, extract durable claims, assumptions, equations, hypotheses, evidence statements. Assign claim IDs. Avoid duplicates.
