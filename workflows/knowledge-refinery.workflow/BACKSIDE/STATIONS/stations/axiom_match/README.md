# ST-AXIOM-001 — Axiom Match

**Lane:** axiom
**Status:** draft
**Folder:** `stations/axiom_match`
**Wraps model:** `M-EMB-SCI-001`

## Purpose

Axiom match: read axioms from Postgres, embed once/cache, brute-force cosine vs incoming claim embeddings; emit top-k matches.
