# ST-NLP-009 — Redundancy Compression

**Lane:** nlp
**Status:** draft
**Folder:** `stations/37_redundancy_compression`
**Wraps model:** `M-REASON-001`

## Purpose

Measure redundancy: repeated claims/metaphors/structures; semantic duplication.
