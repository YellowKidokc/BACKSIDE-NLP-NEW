# ST-NLP-011 — Reader Projection

**Lane:** nlp
**Status:** draft
**Folder:** `stations/39_reader_projection`
**Wraps model:** `M-REASON-001`

## Purpose

Estimate reader projection support: general reader vs skeptic vs theologian vs scientist vs academic.
