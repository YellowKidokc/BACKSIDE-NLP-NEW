# ST-CONV-025 — Frontmatter Builder

**Lane:** conv
**Status:** draft
**Folder:** `stations/25_frontmatter_builder`
**Wraps model:** `local:python`

## Purpose

Inject canonical YAML frontmatter (source_path, sha256, conversion_tool, converted_at, lineage).
