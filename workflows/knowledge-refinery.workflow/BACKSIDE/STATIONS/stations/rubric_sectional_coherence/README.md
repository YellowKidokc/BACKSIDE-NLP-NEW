# ST-SCORE-002 — Rubric Sectional Coherence

**Lane:** score
**Status:** draft
**Folder:** `stations/rubric_sectional_coherence`
**Wraps model:** `M-REASON-001`

## Purpose

Scoring step 2: sectional coherence (score each section by role + coherence).
