# ST-ROUTE-012 — Route Classifier

**Lane:** route
**Status:** draft
**Folder:** `stations/12_route_classifier`
**Wraps model:** `none`

## Purpose

Inspect a dropped file, detect type (PDF/HTML/MD/DOCX/transcript/audio/video/JSON), assign workflow lane, produce routing.yml.
