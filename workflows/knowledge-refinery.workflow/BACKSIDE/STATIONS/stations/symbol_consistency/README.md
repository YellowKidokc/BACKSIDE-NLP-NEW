# ST-NLP-014 — Symbol Consistency

**Lane:** nlp
**Status:** draft
**Folder:** `stations/42_symbol_consistency`
**Wraps model:** `M-CODE-001`

## Purpose

Check internal symbol/variable consistency: variable drift, reuse ambiguity, equation naming stability.
