# ST-SESSION-001 — Session Record Builder

**Lane:** session
**Status:** draft
**Folder:** `stations/session_record_builder`
**Wraps model:** `M-REASON-001`

## Purpose

Emit AI_SESSION record artifact (Goal/Context/Outputs/Decisions/Tasks/Memory/Links).
