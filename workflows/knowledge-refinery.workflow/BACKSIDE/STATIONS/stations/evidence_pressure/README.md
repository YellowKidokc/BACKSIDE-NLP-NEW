# ST-7QS-027 — Evidence Pressure

**Lane:** 7qs
**Status:** draft
**Folder:** `stations/27_evidence_pressure`
**Wraps model:** `M-REASON-001`

## Purpose

Evidence pressure pass: what evidence is missing, what queries to run, what would falsify.
