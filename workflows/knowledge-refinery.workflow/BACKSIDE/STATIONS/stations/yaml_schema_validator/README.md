# ST-YAML-001 — Yaml Schema Validator

**Lane:** yaml
**Status:** draft
**Folder:** `stations/yaml_schema_validator`
**Wraps model:** `M-CODE-001`

## Purpose

Validate frontmatter against Theophysics Master YAML Schema + layer activation rules.
