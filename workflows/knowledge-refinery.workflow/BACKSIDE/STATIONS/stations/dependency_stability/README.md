# ST-NLP-010 — Dependency Stability

**Lane:** nlp
**Status:** draft
**Folder:** `stations/38_dependency_stability`
**Wraps model:** `M-REASON-001`

## Purpose

Measure concept dependency stability: undefined terms, introduced-too-late dependencies.
