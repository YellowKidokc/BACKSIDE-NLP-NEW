# ST-GRAPH-016 — Knowledge Graph

**Lane:** graph
**Status:** draft
**Folder:** `stations/16_knowledge_graph`
**Wraps model:** `none`

## Purpose

Turn paper + claims + 7QS + evidence into nodes and edges (supports/contradicts/depends_on/derives_from/maps_to/cites). Export JSON/CSV for Neo4j or graph viewer.
