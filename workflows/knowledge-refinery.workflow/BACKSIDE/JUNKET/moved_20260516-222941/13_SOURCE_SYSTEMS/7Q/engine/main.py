...
def mode_test(output_dir: str = None):
    ...
    filepath = write_note(profile, result, mode="test", output_dir=output_dir)
    print(f"\n  Test note written to: {filepath}")
    html_path = write_html_report(profile, result, mode="test", output_dir=output_dir)
    print(f"  HTML report:         {html_path}")
