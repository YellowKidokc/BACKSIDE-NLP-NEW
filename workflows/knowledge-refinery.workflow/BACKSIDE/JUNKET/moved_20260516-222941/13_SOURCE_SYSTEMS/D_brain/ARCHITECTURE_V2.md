...
**POF 2828 | 2026-05-02 | North star for the next iteration of D:\brain**
...
- Documents become the source objects.
- Runs become first-class records.
- Model outputs become artifacts, not just overwritten fields.
...
- embed
- route
- classify only where needed
- cluster
- human review for high-value ambiguity
