...
setlocal
echo ============================================
echo  WORKFLOW: transcribe-and-classify
echo  audio/video -> Whisper -> SBERT -> DeBERTa -> JSON + CSV
echo ============================================
...
echo ============================================
echo  Done (rc=%RC%). See D:\brain\_LOGS\workflow_transcribe-and-classify_*.log
echo ============================================
pause
exit /b %RC%
